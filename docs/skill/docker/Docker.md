...
![](https://img.nox.cn/image-20210527011655512.png)

## Docker 的命令

![](https://img.nox.cn/v2-820aee2a33654099d87cdd2b7a1ce741_r.jpg)
...
![](https://img.nox.cn/OIP.p3NmHHlewBvLwukFPGudFgHaFV.jpg)
...
```dockerfile
FROM cetnos
MAINTAINER nox<911993023@qq.com>
...
2、docker login -u nox

3、输入密码

```
[root@localhost ~]# docker login -u nox
Password:
